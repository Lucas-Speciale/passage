...
export const PASSAGE_STORIES: PassageStory[] = [
  ...
  },
  {
    ...
    period: "2021-03",
    category: "Disruption",
    title: "Six days at Suez",
    body: "The container ship Ever Given—chartered by Evergreen Marine—grounds across the canal. Passage records 39.7 tracked daily passages in February, 34.0 in March, and 43.9 after traffic resumes in April.",
  ...
  {
    id: "malacca-data-seam",
    period: "2021-12",
    category: "Data seam",
    title: "When observation changes",
    body: "Malacca brightens abruptly, but official traffic totals show no comparable surge. AIS coverage expands while the number of observed vessels remains nearly unchanged—the safest reading is a change in observation, not a sudden transformation of the route.",
    note: "Maps show what the available data could observe, not the complete world as it was.",
    source: "Global Fishing Watch · IMF PortWatch · STRAITREP",
    lon: 101,
    lat: 2.5,
    side: "left",
  },
