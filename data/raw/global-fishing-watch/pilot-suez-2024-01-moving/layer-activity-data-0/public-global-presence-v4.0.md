...
Filters: vessel_type = 'cargo' AND speed in ('6-10','10-15','15-25') and  timestamp >= parseDateTimeBestEffort('2024-01-01') and timestamp < parseDateTimeBestEffort('2024-02-01')
